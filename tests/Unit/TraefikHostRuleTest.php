...
/**
 * Unit tests for the traefikHostRule() helper that converts wildcard FQDNs to
 * valid Traefik HostRegexp() rules.
 *
 * Traefik 3.x rejects wildcards in Host() / HostSNI() matchers — the router
 * never registers and every request returns HTTP 503.
 *
 * Related issue: https://github.com/coollabsio/coolify/issues/9623
 */
